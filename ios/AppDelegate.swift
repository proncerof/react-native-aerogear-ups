...
@UIApplicationMain
ccd . UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) {
        ...
        registration.register(clientInfo: { (clientInfo) in
            // apply the token, to identify this device
            clientInfo.deviceToken = deviceToken
            
            clientInfo.variantID = "79406d79-2585-48ea-b0f3-7c56b67a955a"
            clientInfo.variantSecret = "b8783806-c926-4e8a-8d8b-24cb0bf5f375"
